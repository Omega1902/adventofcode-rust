#!/usr/bin/env python
# Original Source: https://github.com/ageron/aoc2023-rust/blob/e1c16d9f378449792e9ebf266762dc56d5199cad/get_data.py
# Original Author: Aurélien Geron
...
if year == 2023:
    with open(f"data/{year}/day{day:02}.txt", "w") as f:
        f.write(text)
else:
    print(text)
